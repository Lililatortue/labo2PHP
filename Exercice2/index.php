<?php
require "RDV.php"; //Copy+Paste le .php pour RDV (Rendez-Vous)
...
<body>
    ...
    <div class="flex-container"> <!--Guarder dans 1 ligne (flex)-->
        <a href="index.php?year=<?=$year-1?>&month=<?=$month?>" class="LinkButton">Année précédente</a>
        <h2><?php echo $year; ?></h2>
        <a href="index.php?year=<?=$year+1?>&month=<?=$month?>" class="LinkButton">Année prochaine</a><br>
    </div>

    <div class="flex-container"> <!--Guarder dans 1 ligne (flex)-->
        <a href="index.php?year=<?=$year?>&month=<?=navigateMonth($month,"-")?>" class="LinkButton" style="background-color: blue;">Mois précédent</a>
        <h2><?php echo whatmonthIsIt($month); ?></h2>
        <a href="index.php?year=<?=$year?>&month=<?=navigateMonth($month,"+")?>" class="LinkButton" style="background-color: blue;">Mois suivant</a>
    </div>
